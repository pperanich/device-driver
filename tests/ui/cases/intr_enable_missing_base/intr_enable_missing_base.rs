...
///
/// Root block of the IntrEnableMissingBase driver
#[derive(Debug)]
pub struct IntrEnableMissingBase<I> {
    pub(crate) interface: I,
    #[doc(hidden)]
    base_address: u8,
}
impl<I> IntrEnableMissingBase<I> {
...
impl<I> ::device_driver::Block for IntrEnableMissingBase<I> {
    type Interface = I;
