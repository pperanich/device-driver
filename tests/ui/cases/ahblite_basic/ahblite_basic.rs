...
/// Exercises `sv-bus: ahblite` — emits an AHB-Lite wrapper with the
/// 2-phase address/data protocol bridging to the native CPUIF. Rust
/// target ignores `sv-bus`.
///
/// Root block of the AhbLiteBasic driver
#[derive(Debug)]
pub struct AhbLiteBasic<I> {
    pub(crate) interface: I,
    #[doc(hidden)]
    base_address: u8,
}
impl<I> AhbLiteBasic<I> {
...
impl<I> ::device_driver::Block for AhbLiteBasic<I> {
    type Interface = I;
