...
///
/// Root block of the RalBasic driver
#[derive(Debug)]
pub struct RalBasic<I> {
...
impl<I> ::device_driver::Block for RalBasic<I> {
    type Interface = I;
