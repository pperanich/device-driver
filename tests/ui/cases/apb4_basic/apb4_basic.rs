...
/// Exercises `sv-bus: apb4` device-level property — adds PSTRB + PPROT on
/// top of APB3. Rust target ignores `sv-bus`.
///
/// Root block of the Apb4Basic driver
#[derive(Debug)]
pub struct Apb4Basic<I> {
...
impl<I> ::device_driver::Block for Apb4Basic<I> {
    type Interface = I;
...
impl CtrlFields {
    ...
    /// `31:16` - Read the `threshold` field.
    ///
    #[must_use]
...
impl defmt::Format for CtrlFields {
    fn format(&self, f: defmt::Formatter) {
        ...
        defmt::write!(f, "threshold: {=u16}, ", & self.threshold());
        defmt::write!(f, "}}");
    }
}
